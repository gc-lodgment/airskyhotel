    ...
    <div class="restbar">
        <div class="sub">
            <div class="sub_top_menu">
                <h4 class="page_title">BAR 59</h4>
                <h6 class="page_sub_title">복층구조의 세련되고 스타일리쉬한 인테리어가 돋보이는 로비바에서 커피, 건강차, 칵테일 등 다양한 음료를 즐겨보세요. 소중한 분들과의 만남
                    또는 일상탈피를 통한 삶의 여유를 찾으시기에 최적의 공간입니다.</h6>
                <ul class="menu_wrap container">
                    <li class="menu_item"><a href="/restaurant/valueplate.php">VALUE PLATE</a></li>
                    <li class="menu_item active"><a href="/restaurant/lobbybar.php">BAR 59</a></li>
                    <li class="menu_item"><a href="/restaurant/swimmingbar.php">SWIMMING BAR</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="sub_item">
                        <div class="slick_slider">
                            ...
                            <div class="slick_basic">
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/lobbybar1cd58.jpg">
                                </div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/lobbybar2cd58.jpg">
                                </div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/lobbybar3cd58.jpg">
                                </div>
                            </div>
                        </div>
                        <div class="item_info">
                            <div class="info_wrap">
                                ...
                                <div class="info_content">1층</div>
                            </div>
                            <div class="info_wrap">
                                <h5 class="info_title">운영시간</h5>
                                <div class="info_content">
                                    <span class="sh_small">일요일부터 금요일 오후 13:00 ~ 오후 22:00</span><br />
                                    <span class="sh_small">토요일 및 공휴일 하루 전일 오후 13:00 – 오후 24:00</span>
                                </div>
                            </div>
                            <div class="info_wrap">
                                <h5 class="info_title">메뉴안내</h5>
                                <div class="info_content">
                                    <span class="sh_small">- 커피 : 아메리카노 5,000원 / 카페라떼 5,500원 / 카푸치노 5,500원</span><br />
                                    <span class="sh_small">- 에이드 : 애플 마멀레이드 / 레드 에이드 / 블루 에이드 등 각 6,000원</span><br />
                                    <span class="sh_small">- 칵테일 : 블랙러시안 / 교토 / 모스코우 뮬 / 데킬라 선라이즈 / 진 토닉 등 각 13,000원</span><br />
                                    <span class="sh_small">- 맥주 : 피츠 425ml / 클라우드 425ml 등 각 5,000원</span><br />
                                    <span class="sh_small">- 와인 : 하우스 와인 (잔) 8,000원 / 하우스 와인 (병) 40,000원</span><br />
                                    <span class="sh_small">- 스넥류 : 모듬마른안주 / 나초 / 치킨너겟 등 각 9,900원</span><br />
                                    <span class="sh_small">- 음료 : 콜라 / 다이어트 콜라 / 스프라이트 / 진저에일 등 각 3,000원 / 핫초코 5,500원</span><br />
                                    <span class="sh_small">- 차 : 얼그레이티 5,000원</span><br />
                                    <span class="sh_small">※ 상기 금액은 변동될 수 있습니다.</span><br />
                                </div>
                            </div>
                            <div class="info_wrap">
