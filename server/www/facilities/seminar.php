    ...
    <div class="facilities_box">
        <div class="sub">
            <div class="sub_top_menu">
                <h4 class="page_title">세미나룸</h4>
                <h6 class="page_sub_title">최대 00명까지 수용 가능한 세미나룸은 행사의 목적과 성격에 맞게 이용하실 수 있습니다.<br>대규모 워크샵, 세미나 등의 비즈니스 행사부터 돌잔치, 회갑연 등의 가족모임까지 다양한 연회 행사 진행이 가능합니다.<br>전문적이고 세심한 서비스로 성공적인 행사를 완성해 드립니다.</h6>
        ...
        <div class="sub facilities_box container">
                    ...
                    <div class="sub_item">
                        <div class="slick_slider">
                            ...
                            <div class="slick_basic">
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/seminar/01.jpg" alt="세미나룸사진"></div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/seminar/02.jpg" alt="세미나룸사진"></div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/seminar/03.jpg" alt="세미나룸사진"></div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/seminar/04.jpg" alt="세미나룸사진"></div>
                            </div>
                        </div>
                        <!-- <div class="item_info2">
                            <div class="info_wrap">
                                <div class="b_scroll_x_auto box">
                                    <div class="b_aright">※ 가격 : 세금 불포함 가격입니다. (10% 세금별도)</div>
                                    <table class="meetingroom">
                                        <tr>
                                            <th rowspan="2" class="b_w80">연회장이름</th>
                                            <th rowspan="2" class="b_w40">위치</th>
                                            <th rowspan="2" class="b_w60">면적(m2)</th>
                                            <th rowspan="2" class="b_w100">가로*세로(M)</th>
                                            <th class="b_w100">Round<br />(연회)</th>
                                            <th class="b_w100">Class Room<br />(강의식)</th>
                                            <th class="b_w100">Theater<br />(극장식)</th>
                                            <th class="b_w100">U 형식</th>
                                            <th rowspan="2" class="b_w110">대여요금<br />(All Day)</th>
                                            <th rowspan="2" class="b_w110">대여요금<br />(Half Day)</th>
                                        </tr>
                                        <tr>
                                            <td><img src="http://img.hotelairsky.co.kr/svc/img/facilities/demo3.jpg" />
                                            </td>
                                            <td><img src="http://img.hotelairsky.co.kr/svc/img/facilities/demo4.jpg" />
                                            </td>
                                            <td><img src="http://img.hotelairsky.co.kr/svc/img/facilities/demo2.jpg" />
                                            </td>
                                            <td><img src="http://img.hotelairsky.co.kr/svc/img/facilities/demo1.jpg" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>미시령홀</td>
