    ...
    <div class="restbar">
        <div class="sub">
            <div class="sub_top_menu">
                ...
                <h6 class="page_sub_title">최대 15명이 함께할 수 있는 컨퍼런스룸을 추천드립니다.<br>행사에 필요한 빔프로젝터와 보드 등이 구비되어있어 더욱 원할한 행사 진행이 가능합니다.<br>비즈니스 미팅, 교육은 물론 소규모 연회와 회사 워크샵 등 다용도로 사용할 수 있는 공간입니다.<br></h6>
                    ...
                    <div class="sub_item">
                        <div class="slick_slider">
                            ...
                            <div class="slick_basic">
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/conference/01.jpg" alt="컨퍼런스룸사진"></div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/conference/02.jpg" alt="컨퍼런스룸사진"></div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/conference/03.jpg" alt="컨퍼런스룸사진"></div>
                                <div><img src="http://img.hotelairsky.co.kr/svc/img/facilities/conference/04.jpg" alt="컨퍼런스룸사진"></div>
                            </div>
                        </div>
                        <div class="item_info">
                            <div class="info_wrap">
