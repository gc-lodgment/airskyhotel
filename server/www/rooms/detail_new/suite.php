...
<body class="page-rooms">
    ...
    <div class="sub room_detail">
        ...
        <div class="sub_top_menu">
            <h4 class="page_title">스위트</h4>
            <h6 class="page_sub_title">바다의 장엄한 일출을 볼 수 있으며 쇼파와 테이블이 추가된 스위트 거실 공간을 제공합니다.<br>개인물품 보관을 위한 세이프티박스와 쾌적한 추가 공간이 최고의 만족을 드립니다.</h6>
            ...
            <ul class="menu_wrap container">
                ...
                <li class="menu_item active"><a href="suite.php">스위트</a></li>
            </ul>
        </div>
        ...
        <p>발코니</p>
                    ...
                    <div class="description">
                        ...
                        <div class="cont">
                            <ul class="c_list">
                                ...
                                <li>침대 타입 : 더블 + 슈퍼싱글</li>
                                <li>객실당 인원 : 기준 인원 2인, 최대 인원 3인(추가인원 1인 / 22000원 현장 납부)</li>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="description">
                        ...
                        <div class="cont">
                            <ul class="c_list">
                                <li>어메니티 : 샴푸, 바디워시, 컨디셔너, 로션, 빗, 칫솔, 면도기</li>
                                <li>LED TV(49인치)</li>
                                <li>비데</li>
                                <li>전기포트</li>
                                <li>냉장고</li>
