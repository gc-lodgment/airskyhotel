...
<body class="page-rooms">
    ...
    <div class="sub room_detail">
        ...
        <div class="sub_top_menu">
            <h4 class="page_title">디럭스 오션 트윈</h4>
            <h6 class="page_sub_title">오크 질감의 바닥과 따뜻한 느낌으로 장식 된 객실은 편안함과 안락함을 제공하기 위해 최상의 컨디션을 유지합니다.<br>편안한 개인용 싱글배드와 드넓은 바다 전망으로 특별한 하루를 보내세요.</h6>
