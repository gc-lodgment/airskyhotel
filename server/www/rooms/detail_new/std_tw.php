    ...
    <div class="sub room_detail">
        <div id="slider_room" class="slider_container room">
            <div data-u="slides" class="slides">
                <div data-p="112.50"><img data-u="image" class="room-visibility" src="http://img.hotelairsky.co.kr/svc/img/rooms/std_tw/001.jpg" alt="01" /></div>
        ...
        <div class="sub_top_menu">
            <h4 class="page_title">스탠다드 트윈</h4>
            <h6 class="page_sub_title">모던한 원목 질감의 바닥과 온화한 감성으로 장식된 객실은 안락한 침대와 가구를 갖추고 있습니다.<br>친구, 가족 등 2인 여행객들에게 적합한 개인용 싱글배드 2개를 제공합니다.</h6>
            <!-- menu_item 해당 페이지 active 클래스 추가 -->
            <ul class="menu_wrap container">
                <li class="menu_item"><a href="std_db.php">스탠다드 더블</a></li>
                <li class="menu_item active"><a href="std_tw.php">스탠다드 트윈</a></li>
            ...
            <ul class="menu_wrap container">
                ...
                <li class="menu_item"><a href="pr_oc_db.php">프리미어 오션 더블</a></li>
