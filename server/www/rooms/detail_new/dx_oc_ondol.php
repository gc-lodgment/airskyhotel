...
<body class="page-rooms">
    ...
    <div class="sub room_detail">
        ...
        <div class="sub_top_menu">
            <h4 class="page_title">디럭스 오션 온돌</h4>
            <h6 class="page_sub_title">따뜻한 느낌으로 장식 된 한실 객실로 온돌 타입을 선호하는 여행객 분들께 권합니다.<br>공간 활용에 좋은 한실 타입 객실과 드넓은 바다 전망으로 특별한 하루를 보내세요.</h6>
            ...
            <ul class="menu_wrap container">
                ...
                <li class="menu_item active"><a href="dx_oc_ondol.php">디럭스 오션 온돌</a></li>
