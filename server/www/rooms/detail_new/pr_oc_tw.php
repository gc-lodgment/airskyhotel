...
<body class="page-rooms">
    ...
    <div class="sub room_detail">
        ...
        <div class="sub_top_menu">
            <h4 class="page_title">프리미어 오션 트윈</h4>
            <h6 class="page_sub_title">특별한 하루를 만들어줄 객실은 천장부터 바닥 까지 탁월한 인테러리어 조화로 구성되어 있습니다.<br>친구, 가족 등 2인 여행객들에게 적합한 개인용 싱글배드 2개를 제공합니다.</h6>
            ...
            <ul class="menu_wrap container">
                ...
                <li class="menu_item active"><a href="pr_oc_tw.php">프리미어 오션 트윈</a></li>
                    ...
                    <div class="description">
                        ...
                        <div class="cont">
                            <ul class="c_list">
                                ...
                                <li>침대 타입 : 싱글 + 싱글</li>
                                <li>객실당 인원 : 기준 인원 2인, 최대 인원 3인</li>
                            </ul>
                        </div>
                    </div>
