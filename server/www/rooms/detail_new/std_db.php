...
<body class="page-rooms">
    ...
    <div class="sub room_detail">
        ...
        <div class="sub_top_menu">
            <h4 class="page_title">스탠다드 더블</h4>
            <h6 class="page_sub_title">모던한 원목 질감의 바닥과 온화한 감성으로 장식된 객실은 안락한 침대와 가구를 갖추고 있습니다.<br>여행의 가치를 추구하는 연인, 친구, 가족 2인 고객님께 적합한 더블타입 베드를 제공합니다.</h6>
            <!-- menu_item 해당 페이지 active 클래스 추가 -->
            <ul class="menu_wrap container">
                <li class="menu_item active"><a href="std_db.php">스탠다드 더블</a></li>
