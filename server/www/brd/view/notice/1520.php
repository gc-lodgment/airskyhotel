...
<body>
    ...
    <div class="sub board_view">
        <div class="container box">
            <h3>
                <i class="icon-37"></i> 에어스카이호텔강릉의 강릉거주민 특별 혜택 </h3>
            <div class="brd_info">
                <span>관리자</span>/
                <span><i class="icon-36"></i>2019-01-16</span>/
                <span><i class="icon-35"></i>1012</span>
            </div>


            <div class="brd_cont">
                <p><img alt="" src="http://img.hotelairsky.co.kr/svc/img/brd/notice/1520/img_01.jpg" /></p>
            </div>
